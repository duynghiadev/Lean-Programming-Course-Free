      ...
      link: function (a) {
        ...
        n = function () {
          ...
          if (
            b &&
            a.parentNode &&
            (!f.status || 400 > f.status || 600 < f.status)
          ) {
            b = e.fix(b, !0, a);
            if (d)
              var b = b.replace(
...
(function (k) {
  ...
  if (window.StyleFix && window.getComputedStyle) {
        ...
        l = function (a) {
          if ("-" === a.charAt(0)) {
            ...
            for (b[d] = ++b[d] || 1; 3 < a.length; )
              a.pop(),
                (d = a.join("-")),
                StyleFix.camelCase(d) in h && -1 === c.indexOf(d) && c.push(d);
          }
        };
      ...
      for (g = 0; g < c.length; g++)
        (e = c[g]),
          0 === e.indexOf(a.prefix) &&
            ((f = e.slice(a.prefix.length)),
            StyleFix.camelCase(f) in h || a.properties.push(f));
    ...
    (function () {
      ...
      for (var m in d)
        (g = m + " " + (d[m] || "")),
          !b("@" + g) && b("@" + a.prefix + g) && a.atrules.push(m);
      k.removeChild(e);
    })();
